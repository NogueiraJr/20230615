...
const modulesData = [
  ...
  { id: 'provaRoupa',         seq: "0020", ref: "/prova-roupa",         name: 'Provar Roupas',   description: 'Módulo de Prova de Roupas', },
  { id: 'retiradaRoupa',      seq: "0030", ref: "/retirada-roupa",      name: 'Retirar Roupas',  description: 'Módulo de Retirada de Roupas', },
  { id: 'devolucaoRoupa',     seq: "0040", ref: "/devolucao-roupa",     name: 'Devolver Roupas', description: 'Módulo de Devolução de Roupas', },
  ...
  { id: 'cadastroParceiro',   seq: "0040", ref: "/cadastro-parceiro",   name: 'Cadastrar Parceiros',    description: 'Módulo de Cadastrar Parceiros', },
